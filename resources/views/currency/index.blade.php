...
<div class="block">
    ...
    <div class="block-title">
        <h2><strong>Currencies</strong> List</h2>
    </div>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="btn-group btn-group-xs">
                            <a href="{{route('currency.edit', $currency->id)}}" data-toggle="tooltip" title="Edit" class="btn btn-default "><i class="fa fa-pencil"></i></a>
