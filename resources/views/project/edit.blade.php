...
@section('page-content')
           ...
           <form id="basic-wizard" action="{{route('project.update', $project->id)}}" method="post" class="form-horizontal form-bordered ui-formwizard">
               @csrf
             {{ method_field('patch') }}
                   ...
                   <div class="form-group">
                     ...
                     <div class="col-md-6">
                     <input type="text" name="name" class="form-control" placeholder="Name of the project" value="{{ $project->name or old('name') }}">
                 </div> 
             </div>            
             ...
             <div class="form-group">
                     ...
                     <div class="col-md-6">
                     <input type="text" name="code" class="form-control" placeholder="code of the project" value="{{$project->code or old('code') }}">
                 </div> 
             </div>  
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                       <input type="text" id="start_date" name="start_date" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" value="{{ $project->start_date or old('start_date')}}"> 
                    </div>
                </div> 
             ...
             <div class="form-group">
                    ...
                    <div class="col-md-6">
                       <input type="text" id="completion_date" name="completion_date" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" value="{{ $project->completion_date or old('completion_date')}}"> 
                    </div>
                </div> 
             ...
             <div class="form-group">
                     ...
                     <div class="col-md-6">
                     <input type="number" name="direct_benefeciaries" class="form-control" placeholder="direct_benefeciaries of the project" value="{{ $project->direct_benefeciaries or old('direct_benefeciaries') }}">
                 </div> 
             </div>
           ...
           <div class="form-group">
                     ...
                     <div class="col-md-6">
                     <input type="number" name="D_staff" class="form-control" placeholder="Direct staff of the project" value="{{ $project->D_staff or old('D_staff') }}">
                 </div> 
             </div> 
            ...
            <div class="form-group">
                     ...
                     <div class="col-md-6">
                     <input type="number" name="S_staff" class="form-control" placeholder="Support staff of the project" value="{{ $project->S_staff or old('S_staff') }}">
                 </div> 
             </div> 
           ...
           <div class="form-group">
                    ...
                    <div class="col-md-6">
                     <select id="donor_id" name="donor_id" class="select-select2 select2-hidden-accessible" style="width: 100%;" data-placeholder="Choose one.." tabindex="-1" aria-hidden="true">
                         ...
                         @foreach($donors as $donor)
                           ...
                           <option value="{{$donor->id}}" @if($donor->id == $project->donor_id) selected @endif> {{$donor->name}} </option>
                         @endforeach
                     </select>
             ...
             <div class="form-group">
                      ...
                      <div class="col-md-6">
                      <input type="number" name="Total_budget" class="form-control" placeholder="Support staff of the project" value="{{ $project->Total_budget or old('Total_budget') }}">
                  </div> 
              </div>
             ...
             <div class="form-group">
                      ...
                      <div class="col-md-6">
                      <input type="number" name="Total_salaries" class="form-control" placeholder="Support staff of the project" value="{{ $project->Total_salaries or old('Total_salaries') }}">
                  </div> 
              </div>             
                       ...
                       <div class="col-md-6">
                        <select id="currency_id" name="currency_id" class="select-select2 select2-hidden-accessible" style="width: 100%;" data-placeholder="Choose one.." tabindex="-1" aria-hidden="true">
                            ...
                            @foreach($currencies as $currency)
                              <option value="{{$currency->id}}" @if($currency->id == $project->currency_id) selected @endif> {{$currency->name}} </option>
                            @endforeach
                        </select>
        ...
        <div class="form-group">
                 ...
                 <textarea name="location" class="form-control" rows="8">{{ $project->location or old('location')}}</textarea>
             </div> 
         </div> 
       ...
       <div class="form-group">
                 ...
                 <div class="col-md-6">
                 <textarea name="description" class="form-control" rows="8">{{ $project->description or old('description')}}</textarea>
             </div> 
         </div>
       ...
       <div class="form-group">
                 ...
                 <div class="col-md-6">
                 <textarea name="goals" class="form-control" rows="8">{{ $project->goals or old('goals')}}</textarea>
             </div> 
         </div>
