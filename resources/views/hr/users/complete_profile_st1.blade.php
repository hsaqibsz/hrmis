...
@section('page-content')
 ...
 <div class="block">
    ...
    <form id="basic-wizard" action="{{route('user.complete_profile2', $profile->user_id)}}" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered ui-formwizard">
    @csrf
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" id="father_name"  value="{{$profile->father_name or old('father_name')}}" name="father_name" class="form-control ui-wizard-content" placeholder="Your Father's name..">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                <input type="text" id="dob" name="dob" class="form-control input-datepicker" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" value="{{$profile->dob  or old('dob')}}"> 
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" id="nationality" name="nationality" class="form-control ui-wizard-content" placeholder="Your nationality.." value="{{$profile->nationality or old('nationality')}}" >
                </div>
            </div>     
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" id="masked_phone" name="phone" class="form-control ui-wizard-content" placeholder="(999) 999-9999" value="{{$profile->phone or old('phone')}}">
                </div>
            </div>
...
<div class="col-md-6">
    <input type="text" id="contact_person_name" name="contact_person_name" class="form-control ui-wizard-content" placeholder="Your Contact Person Name.." value="{{$profile->contact_person_name or old('contact_person_name')}}" >
</div>
</div>   
...
<div class="col-md-6">
    <input type="text" id="masked_phone" name="contact_person_phone" class="form-control ui-wizard-content" placeholder="(999) 999-9999" value="{{$profile->contact_person_phone or old('contact_person_phone')}}">
</div>
</div>
...
<div class="divider">Current Address</div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input required type="text" id="current_village"  value="{{$profile->current_village or old('current_village')}}" name="current_village" class="form-control ui-wizard-content" placeholder="Your current Village.">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input required type="text" id="current_district"  value="{{$profile->current_district or old('current_district')}}" name="current_district" class="form-control ui-wizard-content" placeholder="Your current district.">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input required type="text" id="current_province"  value="{{$profile->current_province or old('current_province')}}" name="current_province" class="form-control ui-wizard-content" placeholder="Your current province.">
            </div>
        </div>
